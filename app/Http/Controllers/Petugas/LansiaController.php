...
class LansiaController_p extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('petugas.lansia.index', compact('data'));
    }
    public function create(Request $request)
    {
        // dd("ihan");
        $desa = Desa::all();
        return view('petugas.lansia.form', compact('desa'));
    }
    ...
    {      
        ...
        return view('petugas.lansia.form', compact('data','desa', 'GangguanSelected' , 'FisikSelected', 'P3gSelected','LabSelected'));
    }  
    ...
    public function detail(Request $request, $id)
    {
        ...
        return view('petugas.lansia.detail',
    ...
    public function detail_gangguan($id)
    {
        ...
        return view('petugas.lansia.detail_gangguan',compact('data','riwayat_gangguan'));
    ...
    public function detail_fisik($id)
    {
        ...
        return view('petugas.lansia.detail_fisik',compact('data','pemeriksaanFisik','FisikSelected'));
    ...
    public function detail_lab(Request $request, $id)
    {
        ...
        Paginator::useBootstrap();
        return view('petugas.lansia.detail_lab',compact('data','pemerisaan_lab','statusKoles','statusGula','statusAsamUrat','statusHb'));
    ...
    public function detail_p3g($id)
    {
        ...
        Paginator::useBootstrap();
        return view('petugas.lansia.detail_p3g',compact('data','p3g','statusMal','statusMan'));
