    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">P3g Details</h3>
            </div>
            <!--end::Card title-->
            <!--begin::Action-->
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        <span
                            class="fw-bolder fs-6 text-gray-800 me-2">{{ $data->p3g->last() != null ? $data->p3g->last()->p_resiko_malnutrisi : '-' }}</span>
                        <span class="badge {{ $statusMal == 'Malnutrisi' ? 'badge-danger' : 'badge-success ' }}">{{ $statusMal != null ? $statusMal : '' }}</span>
                    </div>
                </div>
                <!--end::Col-->
            </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px text-center">tingkat mandiri</th>
                        <th class="min-w-125px text-center">Mental Emosional</th>
                        <th class="min-w-125px text-center">Penilaian Resiko Malnutrisi</th>
                        <th class="min-w-125px text-center">Resiko jatuh </th>
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($data->p3g as $key => $val)
                        <tr>
                            ...
                            <!--end::Checkbox-->
                            <!--begin::Email=-->
                            <td class="text-center">{{ $val->tingkat_kemandirian }}
                            </td>
                            <!--end::Last login=-->
                            <!--begin::Name=-->
                            <td class="text-center">
                                <a href="#"class="text-dark fw-bolder text-hover-primary fs-6">{{ $val->g_emosional }}</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Name=-->
                            <td class="text-center">{{ $val->p_resiko_malnutrisi }}</td>
                            <!--end::Name=-->
                            <!--begin::Name=-->
                            <td class="text-center">{{ $val->p_resiko_jatuh }}</td>
                            <!--end::Name=-->
														<td class="text-center">
															<a href="#"class="text-dark fw-bolder text-hover-primary fs-6">{{ $val->g_kognitiv }}</a>
														</td>
                            <!--begin::Joined-->
                            <td class="text-center">{{ $val->tanggal_p_p3g->translatedFormat('d M Y, h:i A') }}
                            </td>
                            <!--end::Email=-->
                            <!--begin::Company=-->
                            {{-- <td>{{ $val->user->nip }}</td> --}}
...
@else
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <!--begin::Card body-->
        <div class="card-body p-9">
            <label class="col-lg-12 fw-bold text-muted text-center">Belum ada melakukan pemeriksaan p3g</label>
        </div>
        <!--end::Card body-->
    </div>
@endif
